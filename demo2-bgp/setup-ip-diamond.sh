...
create_setup () {
  ...
  # Add new configuration for rtrB and rtrC eth3
  $rtrB ip addr add 10.10.6.2/30 dev eth3 || echo "Error configuring rtrB eth3"
  $rtrC ip addr add 10.10.6.1/30 dev eth3 || echo "Error configuring rtrC eth3"
}
...
delete_setup () {
  ...
  # Delete new configuration for rtrB and rtrC eth3
  $rtrB ip addr del 10.10.6.2/30 dev eth3 || echo "Error deleting rtrB eth3"
  $rtrC ip addr del 10.10.6.1/30 dev eth3 || echo "Error deleting rtrC eth3"
}
